...
Status: copied-production rehearsal passed; production activation pending.
...
This rehearsal does not constitute a live deployment or a completed restore
drill. Before activation, take an authoritative stopped-service backup, retain
