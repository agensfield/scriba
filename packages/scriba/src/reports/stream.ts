...
import type { ReportOptions } from './local.ts'
...
export async function buildDailyReportFromAsync(
...
export async function buildWeeklyReportFromAsync(
	events: AsyncIterable<LocalUsageEvent>,
	options: ReportOptions = {},
) {
	const buckets = new Map<string, ReturnType<typeof createBucket>>()
...
export async function buildMonthlyReportFromAsync(
	events: AsyncIterable<LocalUsageEvent>,
	options: ReportOptions = {},
) {
	const buckets = new Map<string, ReturnType<typeof createBucket>>()
...
export async function buildSessionReportFromAsync(
	events: AsyncIterable<LocalUsageEvent>,
	options: ReportOptions = {},
) {
